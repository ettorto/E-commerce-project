...
<body>
    ...
    <?php foreach ($products as $product): ?>
        <div class="col-lg-4 col-md-6 text-center <?php echo $product['cat_name']; ?>">
            <div class="single-product-item">
                <div class="product-image">
                    <a href="single-product.php"><img src="<?php echo $product['product_image']; ?>" alt=""></a>
                </div>
                <h3><?php echo $product['product_title']; ?></h3>
                <p class="product-price"><span>Price:</span> <?php echo $product['product_price']; ?>$ </p>
